<template>
  <el-dialog
    ...
    <el-form-item label="${column.comments}" prop="sessionId">
      <el-input v-model="dataForm.sessionId" placeholder="${column.comments}"></el-input>
    </el-form-item>
    <el-form-item label="${column.comments}" prop="subcribeTime">
      <el-input v-model="dataForm.subcribeTime" placeholder="${column.comments}"></el-input>
    </el-form-item>
    <el-form-item label="${column.comments}" prop="sendTime">
      <el-input v-model="dataForm.sendTime" placeholder="${column.comments}"></el-input>
    </el-form-item>
    <el-form-item label="${column.comments}" prop="noticeType">
      <el-input v-model="dataForm.noticeType" placeholder="${column.comments}"></el-input>
    </el-form-item>
    </el-form>
