<template>
  <el-dialog
    ...
    <el-form-item label="${column.comments}" prop="growBounds">
      <el-input v-model="dataForm.growBounds" placeholder="${column.comments}"></el-input>
    </el-form-item>
    <el-form-item label="${column.comments}" prop="buyBounds">
      <el-input v-model="dataForm.buyBounds" placeholder="${column.comments}"></el-input>
    </el-form-item>
    <el-form-item label="${column.comments}" prop="work">
      <el-input v-model="dataForm.work" placeholder="${column.comments}"></el-input>
    </el-form-item>
    </el-form>
