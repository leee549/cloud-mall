<template>
  <el-dialog
    ...
    <el-form-item label="${column.comments}" prop="subTitle">
      <el-input v-model="dataForm.subTitle" placeholder="${column.comments}"></el-input>
    </el-form-item>
    ...
    <el-form-item label="${column.comments}" prop="img">
      <el-input v-model="dataForm.img" placeholder="${column.comments}"></el-input>
    </el-form-item>
    </el-form>
