<template>
  <el-dialog
    ...
    <el-form-item label="${column.comments}" prop="operateMan">
      <el-input v-model="dataForm.operateMan" placeholder="${column.comments}"></el-input>
    </el-form-item>
    ...
    <el-form-item label="${column.comments}" prop="orderStatus">
      <el-input v-model="dataForm.orderStatus" placeholder="${column.comments}"></el-input>
    </el-form-item>
